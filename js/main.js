$(document).ready(function() {
  ...
  var data = [
    {
      ...
      title: 'TutorBro',
      description:
        'Our Expert Tutor are available 24x7 for your Homework/Assignment Help, Online Classes or Test Preparation with Zero Plagiarism.',
      demoUrl: 'https://tutorbro.com',
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_600/v1519048019/tutorbro.png',
      category: 'frontend',
    },
    {
      id: 23,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_600/v1490456906/Screen_Shot_2017-03-25_at_9.01.02_PM_y7dk6j.png',
      category: 'frontend',
    },
    {
      id: 21,
      title: 'TopGit ★',
      description:
        'Search different programming languages and browse top github projects conveniently.',
      demoUrl: 'https://topgit.vinaypuppal.com',
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1473033629/top-git-ui_zkevgt.png',
      category: 'frontend',
    },
    {
      id: 0,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465247988/fcc/tribute-page-ui.png',
      category: 'frontend',
    },
    {
      id: 1,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465247983/fcc/random-quote-ui.png',
      category: 'frontend',
    },
    {
      id: 2,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465247982/fcc/wiki-search-ui.png',
      category: 'frontend',
    },
    {
      id: 3,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465247982/fcc/local-weather-ui.png',
      category: 'frontend',
    },
    {
      id: 4,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465247982/fcc/js-calculator-ui.png',
      category: 'frontend',
    },
    {
      id: 5,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465247982/fcc/pomodoro-clock-ui.png',
      category: 'frontend',
    },
    {
      id: 6,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465247986/fcc/twitch-streams-ui.png',
      category: 'frontend',
    },
    {
      id: 7,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1466484035/tic-tac-toe-ui_suoxn1.png',
      category: 'frontend',
    },
    {
      id: 8,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,h_300/v1466486988/simon-says-game-ui_nyxr6d.png',
      category: 'frontend',
    },
    {
      id: 9,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465061495/fcc/timestamp-ui.png',
      category: 'backend',
    },
    {
      id: 10,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465067738/fcc/header-parser-ui.png',
      category: 'backend',
    },
    {
      id: 11,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465124936/fcc/ui-url-shortener.png',
      category: 'backend',
    },
    {
      id: 12,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465221550/fcc/img-search-ui.png',
      category: 'backend',
    },
    {
      id: 13,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465395641/file-metadata-ui_vxltxf.png',
      category: 'backend',
    },
    {
      id: 14,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465248106/fcc/youtube-api.png',
      category: 'react',
    },
    {
      id: 15,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/v1466487853/markdown-editor-ui_lpusb2.png',
      category: 'react',
    },
    {
      id: 16,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465247992/fcc/medicloc-ui.png',
      category: 'meteor',
    },
    {
      id: 17,
      ...
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/c_scale,w_300/v1465247989/fcc/amplidudes-ui.png',
      category: 'meteor',
    },
    {
      id: 18,
      ...
      description:
        "A list of Free Code Camp campers who've earned the most brownie points in the past 30 days.",
      demoUrl: 'http://codepen.io/vinaypuppal/full/MeJqzJ/',
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/v1467570960/fcc/fcc-leaderboard-ui.png',
      category: 'react',
    },
    {
      id: 19,
      ...
      demoUrl: 'http://codepen.io/vinaypuppal/live/pbPabb',
      previewUrl:
        'https://res.cloudinary.com/vinaypuppal/image/upload/v1467571176/fcc/recipe-book-ui.png',
      category: 'react',
    },
  ];
  ...
  function generateCard(data) {
    ...
    return (
      ...
      demoUrl +
      ' class="view-demo">View Demo</a></div></li>'
    );
  }
